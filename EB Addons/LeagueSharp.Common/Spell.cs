...
namespace LeagueSharp.Common
{
    ...
    public class Spell
    {
        ...
        public Vector3 From
        {
            get { return !this._from.To2D().IsValid() ? ObjectManager.Player.ServerPosition : this._from; }
        ...
        {
            get { return ObjectManager.Player.Spellbook.GetSpell(this.Slot); }
        }
        ...
        public int Level
        {
            get { return ObjectManager.Player.Spellbook.GetSpell(this.Slot).Level; }
        }
        ...
        {
            get { return ObjectManager.Player.Spellbook.GetSpell(this.Slot).ManaCost; }
        }
        ...
        {
            get { return this.Range*this.Range; }
        }
