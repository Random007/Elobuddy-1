...
namespace LeagueSharp.Common
{
    ...
    public class PredictionInput
    {
        ...
        {
            get { return this.UseBoundingRadius ? this.Radius + this.Unit.BoundingRadius : this.Radius; }
        }
    ...
    public class PredictionOutput
    {
        ...
        {
            get { return Math.Max(this._aoeTargetsHitCount, this.AoeTargetsHit.Count); }
        }
    ...
    internal class StoredPath
    {
        ...
        {
            get { return this.Path.LastOrDefault(); }
        }
        ...
        public double Time
        {
            get { return (Utils.TickCount - this.Tick)/1000d; }
        }
