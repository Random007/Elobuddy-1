...
namespace Nautilus
{
    public static class DamageIndicator
    {
        ...
        public static void LoadDamageIndicator()
        {
        ...
        private static void Drawing_OnEndScene(EventArgs args)
        {
                ...
                )
            {
                ...
                if (MyMenu.DrawingsMenu.GetCheckBoxValue("damageColorBox"))
                {
                    ...
                    var colour = MyMenu.DamageIndicatorColorSlider.CurrentColor;
                    Line.DrawLine(colour, Thick, initPoint, endPoint);
                }

                if (MyMenu.DrawingsMenu.GetCheckBoxValue("statDraw"))
                {
                    //Statistics
                    ...
                    _Font2.DrawText(null, mathStat, posXStat, posYStat, MyMenu.DamageIndicatorColorSlider.CurrentColor.ToSharpDX());
                }

                if (MyMenu.DrawingsMenu.GetCheckBoxValue("perDraw"))
                {
                    //Percent
                    ...
                    _Font.DrawText(null, string.Concat(Math.Ceiling((int)damage / enemy.TotalShieldHealth() * 100), "%"),
                        posXPer, posYPer, MyMenu.DamageIndicatorColorSlider.CurrentColor.ToSharpDX());
                }
            }
        }
    }
