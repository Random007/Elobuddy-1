...
using EloBuddy;
using EloBuddy.SDK;
using KA_Activator.Maps.HowlingAbyss.DMGHandler;
using Misc = KA_Activator.Maps.HowlingAbyss.Config.Types.Settings;
using Settings = KA_Activator.Maps.HowlingAbyss.Config.Types.SummonerSpells;

namespace KA_Activator.Maps.HowlingAbyss.SummonerSpells.Spells
{
    internal class Heal
    {
