...
using Settings = KA_Trackers.Config.Types.SpellTracker;
...
namespace KA_Trackers
{
    internal class SpellsTracker
    {
        ...
        public static void Initialize()
        {
            ...
            TextureLoader.Load("hud", Resource1.hud2);
            ...
            TextureLoader.Load("summonersmite", Resource1.SummonerSmite1);
            TextureLoader.Load("s5_summonersmiteduel", Resource1.SummonerRedSmite);
            TextureLoader.Load("s5_summonersmiteplayerganker", Resource1.SummonerBlueSmite);
            ...
            foreach (var summoner in EntityManager.Heroes.AllHeroes.SelectMany(o => o.Spellbook.Spells.Where(s => Summoners.Contains(s.Slot))).Select(o => o.Name.ToLower()))
            {
                ...
                switch (summonerName)
                {
                    ...
                    case "summonerclarity":
                        bitmap = Resource1.SummonerClarity;
                        break;
                        //Garrison
                    case "summonergarrison":
                        bitmap = Resource1.SummonerGarrison;
                        break;
                        //Ghost
                    case "summonerhaste":
                        bitmap = Resource1.SummonerGhost;
                        break;
                        //Heal
                    case "summonerheal":
                        bitmap = Resource1.SummonerHeal;
                        break;
                        //SnowBall
                    case "summonersnowball":
                        bitmap = Resource1.SummonerSnowBall;
                        break;
                        //Barrier
                    case "summonerbarrier":
                        bitmap = Resource1.SummonerBarrier;
                        break;
                        //Exhaust
                    case "summonerexhaust":
                        bitmap = Resource1.SummonerExhaust;
                        break;
                        //Cleanse
                    case "summonerboost":
                        bitmap = Resource1.SummonerCleanse;
                        break;
                        //TP
                    case "summonerteleport":
                        bitmap = Resource1.SummonerTeleport;
                        break;
                        //ClairVoyance
                    case "summonerclairvoyance":
                        bitmap = Resource1.SummonerClairvoyance;
                        break;
                        //Flash
                    case "summonerflash":
                        bitmap = Resource1.SummonerFlash;
                        break;
                        //Ignite
                    case "summonerdot":
                        bitmap = Resource1.SummonerIgnite;
                        break;
                    case "summonersmite":
                        bitmap = Resource1.SummonerSmite1;
                        break;
                        //RedSmite
                    case "s5_summonersmiteduel":
                        bitmap = Resource1.SummonerRedSmite;
                        break;
                        //BlueSmite
                    case "s5_summonersmiteplayerganker":
                        bitmap = Resource1.SummonerBlueSmite;
                        break;
                }
