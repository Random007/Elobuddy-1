        ...
        public static float GetRealDamage(this SpellSlot slot, Obj_AI_Base target)
        {
            ...
            switch (slot)
            {
                case SpellSlot.Q:
                    ...
                    damage = new float[] { 70, 110, 150, 190, 230 }[spellLevel] + 0.6f * Player.Instance.FlatMagicDamageMod + 1f * Player.Instance.FlatPhysicalDamageMod;
                    break;

                case SpellSlot.W:

                    damage = new float[] { 40, 75, 110, 145, 180 }[spellLevel] + 0.6f * Player.Instance.FlatMagicDamageMod;
                    break;

                case SpellSlot.E:

                    damage = new float[] { 50, 75, 100, 125, 150 }[spellLevel] + 0.5f * Player.Instance.FlatPhysicalDamageMod;
                    break;
